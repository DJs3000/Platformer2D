...
Aseprite LoadAsepriteFromMemory(const unsigned char* fileData, int size);  // Load an aseprite file from memory
 ...
 * @see LoadAseprite()
 */
Aseprite LoadAsepriteFromMemory(const unsigned char* fileData, int size) {
